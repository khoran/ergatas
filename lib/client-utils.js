...
function displayDonatePopup(missionary_profile_key, donation_url,instructions,ownProfile){
    var dialogContent;
...
export function donate(profile,source,ownProfile){
    ...
    displayDonatePopup(profile.missionary_profile_key,
...
export function donatePreview(url,instructions){
    displayDonatePopup(0,url,instructions,true);
};
