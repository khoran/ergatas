...
export class AppState{
    ...
    causeArray(cause_keys,asObject){
        return utils.selectedKeysAsArray(cause_keys,this.causes(),"cause_key","cause",asObject);
    };
    ...
    async updateCauseList(){
        return this.updateList(this.da.causeList(),this.causes);
    }
