...
class Client {
    ...
    initTemplates(){
        const pages = ['home','about','search','edit-profile','not-found','org-application','profile-detail'];
        const snippets = [];
    ...
    getSnippet(name){
        return this.templates.snippet[name];
    }
    ...
    initRouter(){
        ...
        router.add('search/', function () {
            viewModel.query("");
            viewModel.page(self.getPage("search"));
        ...
        router.add('profile/', function () {
            if(viewModel.loggedIn())
                ...
                viewModel.page(self.getPage("edit-profile"));
            else
