...
constructor(){
    ...
    this.urlParams = utils.getParams();
...
setupSearchFromUrl(){
    ...
    var organizationKey= this.urlParams.organizationKey;
    console.log("parameter organizationKey: ", organizationKey);
    this.viewModel.filter.organizations.obs()([organizationKey]);
}
