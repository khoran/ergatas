        ...
        navigator.serviceWorker.register('/service-worker.js')
            .then((reg) => {
                ...
                setInterval(function(){
                    console.info("SW Checking for service worker update");
                    reg.update();
...
initRouter(appBase,authBaseUrl,authClientID){
    ...
    router.add('profile-detail/(:num)', async function (missionary_profile_key) {
        ...
        try{
            ...
            await self.appState.updateApprovedOrgList();
            await self.appState.updateTagList();
            await self.appState.updateJobList();
