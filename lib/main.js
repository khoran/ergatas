...
initTemplates(){
    ...
    const pages = ['about','search','edit-profile','not-found',
    ...
    //special case for home page, since we line it.
    this.templates.pages.home = jQuery("#home");
}
initChatra(){
    (function(d, w, c) {
...
initViewModel(authBaseUrl,clientId,redirect,bucketBase,appBase){
    ...
    viewModel.showFilePicker = async function(profile){
