...
initViewModel(authBaseUrl,clientId,redirect,bucketBase,appBase){
    ...
    viewModel.showFilePicker = function(){
        console.log("showing robodog file picker");

        const uppy = uploaderUtils.profileUploader( viewModel.loggedInUser().external_user_id());
        //clear files
