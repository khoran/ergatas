...
export class Search {
    constructor(appBase,da){
        ...
        self.searchInProgress = ko.observable(false).extend({rateLimit:10000});
        ...
        // reset search results when any filter changes
        ...
        ko.computed(async function(){
            ...
            if(utils.getCurrentRootPage(appBase) !== "search")
                return; 
