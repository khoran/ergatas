...
export class AppState{
    constructor(da,search,storage,router,server) {
        ...
        self.taxReceiptCountryCountsList = new CachedList(
            () => self.da.taxReceiptCountryCounts(),
            (keys,data) => utils.selectedKeysAsArray(keys,data,"country_code","country_code",true));
