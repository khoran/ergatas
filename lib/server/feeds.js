...
export class Feeds{
        ...
        const missionaryOfTheDayOptions = Object.assign({},commonOptions,
            {
                ...
                description:"Learn about a missionary, pray for them, partner with them. #missionaryoftheday #prayforamissionary #mod #missionary",
                feed_url:urlBase+"/feeds/missionaryOfTheDay",
            });
        const newMissionariesOptions = Object.assign({},commonOptions,
            {
                title:"New Missionaries",
                description:"New missionaries to learn about, pray for, and partner with #prayforamissionary #missionary",
    ...
    addRandomMissionary(profile) {
        this.missionaryOfTheDay.item(this.profileItemOptions(profile));
    }
    addNewMissionary(profile){
        this.newMissionaries.item(this.profileItemOptions(profile,profile.created_on));
    }
    ...
    profileItemOptions(profile,date=new Date()){
        const options = {
            title: `Meet ${profile.missionary_name}`,
            description: `Learn about the ministry of ${profile.missionary_name}. Pray for them. If you feel a connection with their ministry, consider partnering with them`,
