...
export class Feeds{
    ...
    addRandomMissionary(profile) {
        this.missionaryOfTheDay.item(this.profileItemOptions("",profile, "#Missionary #PrayForAMissionary #Ergatas"));
    }
    addNewMissionary(profile){
        this.newMissionaries.item(this.profileItemOptions("New Missionary on Ergatas!",profile,"#Missionary #Ergatas",profile.created_on));
    }
