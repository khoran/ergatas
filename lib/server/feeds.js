...
export class Feeds{
    ...
    addRandomMissionary(profile) {
        this.missionaryOfTheDay.item(this.profileItemOptions("",profile, "#MissionaryOfTheDay #PrayForAMissionary #Ergatas #Missionary"));
    }
    addNewMissionary(profile){
        this.newMissionaries.item(this.profileItemOptions("New Missionary on Ergatas!",profile,"#PrayForAMissionary #Missionary #Ergatas",profile.created_on));
    }
