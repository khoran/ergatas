...
export class CachedList{
    constructor(updateFn, selectFn, minUpdateTime = 300){
        ...
        // Lazy: the first accessor (listObs/findItem/selectItems) triggers the
        // fetch. Fetching here in the constructor made every page load all six
        // AppState lists (~130KB of XHRs + JSON parsing) during boot, whether
        // the page used them or not.
    ...
    selectItems(keys,resultObs){
        ...
        return self.ensureLoaded().then( data =>{
