        ...
        if(pageName === "" || pageName === "home" || pageName === "index"){
            $("head").append(jsonLdScript({
                ...
                "description":"A free website connecting Christian supporters with missionaries raising financial support. "+
                    "Search for missionaries across many sending organizations by location, people group, vocation, or "+
                    "support level, then pray for, follow, or donate to them.",
                "url":`https://${domain}/`,
                "logo":`https://${domain}/img/ergatas2-light-green.png`,
                "sameAs":[
...
export function llmsTxt(pageInfo){
    ...
    llmsTxtCache = [
        ...
        "cause, or support level, then pray for, follow, or donate to them. Ergatas is free for "+
