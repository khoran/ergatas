...
export async function pickPrayerCardDrawingWinner(){
    try{
        ...
        var user_key = (await getDB().getUserForPrayerCardDrawing()).data.user_key;
    user_key = 102; // DEBUG ONLY
        console.log("prayer card winner: ",user_key);
...
Create an account, then you can use an existing template or use Canva and design your own card. 
After that upload your addresses and then place your order. 

To get reimbursed, send a screen shot of your order to andrew.feng@indigitous.org and
he'll send you money via Venmo or PayPal.
