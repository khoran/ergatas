    ...
    */
    ...
    try{
        ...
        const donationStats = await analyticsQuery({
            ...
            filters:"ga:eventCategory==donations level 1;ga:eventLabel=="+missionary_profile_key,
        },accessToken);
        ...
        const pageStats = await analyticsQuery({
            ...
            filters:"ga:pagePath=@/profile-detail/"+missionary_profile_key+";ga:pagePath!@code",
        },accessToken);
        ...
        const prayerStats = await analyticsQuery({
            metrics:"ga:uniqueEvents",
            filters:"ga:eventAction==prayed;ga:pagePath=@/profile-detail/"+missionary_profile_key+";ga:pagePath!@code",
        },accessToken);
