...
export async function getWorkerDonations(userId,token){
    ...
    try{
        ...
        let org_key =  (await getDB(token).getUserOrgSearchFilter(userId));
...
export async function copyEmailTemplate(sourceTemplate,destTemplate){
    ...
    mg.domains.domainTemplates.get(domain,sourceTemplate,{active:"yes"}).then( sourceData => {
        ...
        mg.domains.domainTemplates.create(domain,destData).then( body => {
