...
export function handleStripeEvent(body,sig){
...
export async function makeDonation(name,amount){
    ...
    console.local("createing stripe session");
    try{
        ...
        const session = await s.checkout.sessions.create({
            line_items: [
            {
                price_data:{
                    ...
                    product_data:{
                        name: name,
                        description: "Donate to the ministry of "+name,
                        images: [
                            "https://ergatasstorage.blob.core.windows.net/ergatas-public-content/a1da7bec-d229-4da7-8b74-0d5a2448a41a/Kevin_and_Ruth.jpg"
                        ],
                    },
                    unit_amount:amount,
                    recurring:{
