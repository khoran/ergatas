...
import { SocialMediaPostsRepo } from './repos/social-media-posts-repo.js';
...
export class DataAccess {
    ...
    constructor(postgrestBase,ajaxFn,refreshAuthFn){
        ...
        this.socialMediaPosts = new SocialMediaPostsRepo(this.#client);
        ...
        this.#bindFlat([
            this.users, this.profiles, this.posts, this.socialMediaPosts, this.searches,
