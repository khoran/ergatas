...
export function register(){
    ko.components.register('profile-collection', {
        viewModel: function(params) {
            ...
            self.userFavorites = utils.getUserFavoritesLazy(loggedInUser(), self.da);
            ...
            self.getProfileObservables = function(profile) {
                ...
                if (!self.profileObservables[key]) {
                    self.profileObservables[key] = {
                        ...
                        isFavorite: utils.isFavorite(profile,self.userFavorites),
                    };
                }
            ...
            self.getIsFavoriteObs = function(profile) {
