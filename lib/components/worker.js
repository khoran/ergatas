   ...
   ko.components.register(NAME, {
        viewModel: function(params) {
            ...
            self.isFavorite = ko.observable(
                params.appState.loggedInUser()
                && params.appState.loggedInUser().search_filter
                && params.appState.loggedInUser().search_filter.ro_profile_keys
                && params.appState.loggedInUser().search_filter.ro_profile_keys().indexOf(self.profile.missionary_profile_key) !== -1);
            ...
            self.toggleFavorite = function(){
                var user = params.appState.loggedInUser();
