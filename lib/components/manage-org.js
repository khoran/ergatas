...
export function register(){
    ...
    ko.components.register(name, {
        viewModel: function(params){
                ...
                // params.db should be the parent dashboard viewmodel (renamed to `db`)
                ensureFields(params,["appState","db"]);
                self.db = params.db;
                ...
                async function loadManagingOrg(){
                    ...
                    const da = params.appState.da;
                    const getUser = params.db.getUser; // dashboard exposes getUser as a function
                    if(!da || !getUser) return;
