...
export function register() {
    ...
    ko.components.register(name, {
        viewModel: function (params) {
            ...
            // Delete a specific document record (invoked by worker-document-list
            // with the record itself, so the right row is removed even when two
            // records share a storage_path).
            self.onDeleteDoc = async function (doc) {
