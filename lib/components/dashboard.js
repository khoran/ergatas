...
export function register(){
   ...
   ko.components.register(name, {
       viewModel: function(params) {
            ...
            // expose appState/server/da on the dashboard vm so helpers can access them
            self.appState = appState;
            self.server = server;
            self.da = da;
            const getUser = params.user;
            // expose getUser so moved helpers can access the logged-in user
...
//
            ...
            // show/hide wiki page manager in sidebar
            self.showWiki = ko.observable(false);
