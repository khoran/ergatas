   ...
   ko.components.register(name, {
      viewModel: function(params) {
            ...
            self.dashboardPage.subscribe(function(newTemplate){
                ...
                //if the URL already matches, this write came from getTemplateFromURL() itself;
                // re-navigating here would rebuild the whole dashboard component and loop forever
                if(newTemplate === getTemplateFromURL()) return;
            ...
            //the landing pane (next steps + stats) is its own component; see
            //the dashboard-home template below
