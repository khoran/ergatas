       ...
       viewModel: function(params) {
           ...
           if(self.search.searchResultsTemplate() == null)
            ...
            self.saveSearch = function(){
                ...
                var searchParams = self.search.genSearchParams(self.search.filter,true);
                console.log("search params: ",searchParams);
                console.log("user profile: ",self.userProfile());
                if(self.userProfile != null && self.userProfile() != null){

                    //save to db
                    self.da.createSavedSearch(self.userProfile().user_key(),{
                                                name: self.savedSearchName(),
                                                params: searchParams,
                                            }).
                            then( () => self.showSearchNameInput(false));
            ...
            self.movementSelectizeFilterOptions = {
             ...
             self.culturalDistanceSelectizeFilterOptions= {
                maxItems:10,
                plugins:['remove_button'],
