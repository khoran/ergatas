...
<div class="row">
    <div class="col-lg-5">
        ...
        <form class="shaded-bg" data-bind="submit: saveNonProfit,with:nonProfit">
            ...
            <div class="my-3 form-check">
                <input type="checkbox" class='form-check-input' id="provides_tax_receipt"
                        data-bind="checked: donation_settings.provides_tax_receipt"/>
                <label class="form-check-label" for="provides_tax_receipt">
                    Provides tax receipts valid in its own country
                </label>
            </div>
