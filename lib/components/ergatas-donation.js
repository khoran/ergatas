 ...
 *      - fundId: which fund to apply donation to. ID can be gotten from list of funds in bloomerang
 */
...
export function register() {
    ...
    ko.components.register(name, {
        viewModel: function (params) {
            ...
            // funds: general (id: 10), worker (id: 68608)
            ...
            if(params.fundId){
              if(ko.isObservable(params.fundId))
                self.fundId =  params.fundId() || 10;  //default to general fund
              else
                self.fundId = params.fundId;
            } else
              self.fundId = 10;

            console.log("final fundId: "+self.fundId);

            bloomerangInit(self.state,self.funds,self.fundId);
...
function bloomerangInit(pageState,funds,fundId){
...
'    </div>'+
        ...
        '</div>' + 
        '<div class="field  frequency form-group required-star" style="display: none">' + 
 ...
 '    <div class="my-4 section true-impact">' + 
        ...
        '      <div class="field text first-name form-group required-star" >' + 
        ...
        '      <div class="field text form-group payment required-star">' + 
...
'' +  '';
        ...
        var toggleOtherAmountRequired = function () { 
          jQuery(".donation-form #other-amount").toggleClass("required-star",
