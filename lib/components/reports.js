...
export function register(){
   ...
   ko.components.register(name, {
       viewModel: function(params) {
                ...
                jQuery(".donation_table").DataTable({
                    ...
                    columns:[
                        ...
                        },
                        {
                            ...
                            data:"stripe_id",
                            render:function(data,type,row){
                                return `<a href='https://dashboard.stripe.com/search?query=${data}' target='_blank' rel='noopener'>${data}</a>`;
                            }
                        },
                        {
                            title: "Paid",
                            ...
                            render: function(data,type,row){
                                if(data === true){
                                    ...
                                    return `<button class='btn btn-primary btn-sm' 
                                            onclick="window.ergatas.markPaid(${row.possible_transaction_key})">Mark Paid</button>`;
                                }
                            }
                        }
                    ]
            ...
            window.ergatas={};
            window.ergatas.markPaid= async function(possible_transaction_key){
