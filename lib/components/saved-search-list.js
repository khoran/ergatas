        ...
        viewModel: function(params) {
            ...
            self.run = function(search){
                ...
                if(search.public_search_key != null)
                    params.navigateFn("search/public/"+encodeURIComponent(search.search_name),"saved-search")();
                else
                    params.navigateFn("search/saved/"+self.user().user_key()+"/"+encodeURIComponent(search.data.name),"saved-search")();
            }
