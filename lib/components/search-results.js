   ...
   ko.components.register(NAME, {
       viewModel: function(params) {
           ...
           if(self.search.searchResultsTemplate() == null)
            ...
            //self.orgTagCloudMap = ko.computed(() => {
            //    const orgs = orgsWithProfiles();
            //    if (!orgs) return {};
            //    const result = {};
            //    orgs.forEach(org => {
            //        result[org.organization_key] = {
            //            count: org.count || 0,
            //            name: org.name
            //        };
            //    });
            ...
            //self.toggleOrgFilter = function(orgKey) {
            //    const current = self.search.filter.organizations.obs()() || [];
            //    const index = current.indexOf(orgKey);
            //    if (index > -1) {
            //        current.splice(index, 1);
            //    } else {
            //        current.push(orgKey);
            //    }
            //    self.search.filter.organizations.obs()(current.length ? current : undefined);
            //};
