...
export function register(){
   ...
   ko.components.register(NAME, {
       viewModel: function(params) {
            ...
            self.appState.updateTagList().then( () => self.profile.tag_keys.valueHasMutated())
            self.appState.updateCauseList().then( () => self.profile.cause_keys.valueHasMutated())
            ...
            self.causeSelectizeOptions= {
                ...
                onInitialize: function(){
                    ...
                    ko.bindingHandlers.selectize.utils.setOptions(api,self.appState.causes);
                    ko.bindingHandlers.selectize.utils.watchForNewOptions(api,self.appState.causes);

                    if( self.profile != null && self.profile.cause_keys() != null)
                        ko.bindingHandlers.selectize.utils.setItems(api,self.profile.cause_keys);
                },
                onObsUpdate: onObsUpdate
            };
