        ...
        viewModel: function(params) {
            ...
            async function searchByBounds(){
                ...
                try{
                    ...
                    params.output_profilesInArea(searchResults.map((x) => x.missionary_profile_key));

                    map.removeObjects(map.getObjects());

                    addClusters(searchResults,clusteredDataProvider);
                }catch(error){
            ...
            // TODO: instead of watching params.profiles, need to do a second 
            //   search with same parameters but return only coords for all
            //   profiles. This allows full profiles to be paged
    ...
    if(Array.isArray(data)){
        ...
        ko.applyBindings({
            ...
            fullUrl: function(profile) {                                
                return profileControls.pictureUrl(profile.picture_url);
            },
        ...
        ko.applyBindings({
            ...
            fullUrl: profileControls.pictureUrl(profile.picture_url),
        },html);
