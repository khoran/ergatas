...
export function register(){
   ...
   ko.components.register(NAME, {
       viewModel: function(params) {
            ...
            //default the native currency to the selected country's currency until
            // the user makes their own selection
            ko.computed(()=>{
                const application = self.organizationApplication();
                ...
                if(defaultCurrency != null && selected != null && selected().length === 0)
