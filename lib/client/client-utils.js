...
export function currencySelectizeOptions(currencies,initialItems){
    return defaultSelectizeOptions(currencies,initialItems,"key","name","name");
}
...
export function getSearchNameFromURL(){
    ...
    var match = /^\/search\/saved\/([-a-zA-Z0-9"' ]+)/.exec(decodeURI(url.pathname));
    console.log("searchname match from URL: ",match,url);
