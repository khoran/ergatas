...
uppy.use(Transloadit,{
    providers: [ 'instagram', 'url', 'webcam', 'dropbox', 'facebook', 'onedrive' ],
...
// uppy.use(GoogleDrivePicker, { target: Dashboard, companionUrl: Transloadit.COMPANION, companionAllowedHosts: Transloadit.COMPANION_PATTERN})
