...
export function workerDocumentUploader(prefix) {
    console.log("template id: ", process.env.WORKER_DOC_UPLOAD_TEMPLATE);
    return buildUppy({
        templateId: process.env.WORKER_DOC_UPLOAD_TEMPLATE,
        fields: { userId: prefix },
        restrictions: {
