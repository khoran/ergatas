...
const lazyComponents = {
    ...
    "dashboard-home":        () => import(/* webpackChunkName: "cmp-dashboard" */ '../components/dashboard-home'),
    "donation-list":         () => import(/* webpackChunkName: "cmp-dashboard" */ '../components/donation-list'),
    "donor-donations":       () => import(/* webpackChunkName: "cmp-dashboard" */ '../components/donor-donations'),
