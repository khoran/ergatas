...
constructor(){
    ...
    if(donationResult != null) //clear this parameter from the location bar so users don't reload it
...
initViewModel(authBaseUrl,clientId,redirect,appBase,appState){
    ...
    viewModel.hasGuidedSearch = ko.computed(function(){
        //TODO: see if we can avoid calling out to the db each time to check
    ...
    viewModel.editProfile = function(profileData){
        console.log("loading profile page to edit ",profileData);
        viewModel.editingProfile(profileData);
        viewModel.navigateFn('profile/edit')();
...
initRouter(appBase,authBaseUrl,authClientID){
    ...
    router.add('profile/edit', async function () {
        console.log("nav to profile/edit",viewModel.editingProfile(),viewModel.roles());
        if(viewModel.loggedIn() 
            && viewModel.hasRole("profile_manager") 
    ...
    //router.add('donate/', function () {
        //setPage("donate");
    //});
    //router.add('worker-donation/', function () {
        //setPage("worker-donation");
    //});
   ...
   // router.add('profile-saved/', function () {
   //     setPage("profile-saved");
   // });
   // router.add('daily-prayer/', function () {
   //     setPage("daily-prayer");
   // });
   // router.add('saved-searches/', function () {
   //     setLoggedInPage("saved-searches");
   // });
   // router.add('guided-search/', function () {
   //     setPage("guided-search");
   // });
