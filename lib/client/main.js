...
initViewModel(authBaseUrl,clientId,redirect,appBase,appState){
    ...
    const viewModel = {
        ...
        loadProfile: async function(user_key){
            ...
            var savedData;
            try{
                // profile_managers don't have one unique role, they can
                // choose what profile to edit from the list later
                if(viewModel.hasRole("profile_manager"))
                    return;
    ...
    viewModel.isOrganizationSlug = async function(){
