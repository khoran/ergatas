...
async initPrayerNotifications(){
    ...
    utils.scheduleFunction("09:00",async function(){
        ...
        navigator.serviceWorker.getRegistration().then(function(reg) {
            reg.showNotification("Ergatas Notice" ,{
                ...
                body: "Pray for "+profile.missionary_name,
                icon: "/favicon.ico",
                data:{
                    missionary_profile_key: profile.missionary_profile_key,
                },
            });
            dataLayer.push({event:'user','user-action':"prayer-notification","user_id":viewModel.userId()});
        });
    });
}
