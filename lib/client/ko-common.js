...
ko.bindingHandlers.clamped= {
  init: function(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
    ko.bindingHandlers.clamped.update(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext);
  },
  update: function(element, valueAccessor) {
    var selector = valueAccessor();
    var clampValue = 15;
    var maxHeight = utils.getMaxHeight(clampValue,element);
    var sty = element.style;
    var toggle = jQuery(element).siblings(selector);
